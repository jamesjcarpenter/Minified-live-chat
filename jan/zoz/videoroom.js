					...
					var ju = {"request" : "listforwarders",  "room" : myroom }
								...
								onlocalstream: function(stream) {
									...
									if($('#myvideo').length === 0) {
										...
										$('#videolocal').append('<button class="ui small red compact button" id="unpublish" style="position: absolute; bottom: 10%; left: 50%; margin: 15px;"><i class="times circle icon">EXIT</i></button>');
