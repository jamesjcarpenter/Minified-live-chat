			...
			janus = new Janus(
				{
					...
					iceServers: [{urls: "stun:stun.l.google.com:19302"}],
											[{urls: "turn:165.22.137.67:3478?transport=udp", username: "apostles00", credential: "Zero!"}],
											[{urls: "turn:165.22.137.67:3478:3478?transport=tcp", username: "apostles00", credential: "Zero!"}];
					success: function() {
						...
						janus.attach(
							{
								...
								onlocalstream: function(stream) {
									...
									if($('#myvideo').length === 0) {
										$('#videolocal').append('<video class="ui image small" id="myvideo" width="100%" height="100%" autoplay playsinline muted="muted"/>');
										// Add a 'mute' button
