...
socket.on('connect', function(data) {
  ...
  socket.on('updatehomepage', function(rooms, curRoom) {
      ...
      $.each(rooms, function(key, value, curRoom) {
          $('#goa').append('<div class="five wide column"></div><a href="/room/' + value + '">' + '<div class="ui segment"id="rightlabelroom"><h3>' + value + '</h3>' + '<p>sasdkjsakjdnaskjndkajsdnjkasnjkdsan</p>'  + '</div></a>' + '<div class="ui basic segment"id="seg"></div>');
