  ...
  socket.on('updateusers', function(data) {
    ...
    $('#userlist').append('<h6 class="list-group-item-heading">' + 'Users in room' + '&nbsp;#' + '' + socket.room + '</h6>');
		$.each(data, function(key, value) {
			$('#userlist').append('<div id="connecteduser">' + key + '&nbsp;&nbsp;' + '<i class="circle icon green"></i><button type="button" class="btn btn-primary btn-xs"id="PMbutton"><span class="ui small text">PM</span></button></div>');
		});
	});
