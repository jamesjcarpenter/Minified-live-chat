...
var date = JSON.stringify(new Date(Date.now()).toLocaleTimeString())
  ...
  socket.on('updateusers', function(data) {
    ...
    // $('#userlist').append('<div class="list-group-item-heading"><span class="ui white text">' + 'online' + '<br>' + 'room &nbsp;#' + '' + socket.room + '</span></div><br><br>');
		$.each(data, function(key, value, id) {
			$('#userlist').append('<li><a class="ui gray circular image label"id="imagelabel"><img src="/images/avatarsmall.jpg">' + '<span class="ui white text user" data-value="' + id + '">' + key  + '</span>' + '</a>' + '</li>');
      console.log(value);
