...
var socket = io.connect('anomic.io/');
  ...
  socket.on('updatechat', function (username, data) {
    ...
    $('#conversation').append($('<div class="thismessage"><div class="ui left pointing label"id="message"name="data"><div id="messagedata"><p class="messaging"><span class="ui small text"></span></p></div></div></div>').text(data));
  });
