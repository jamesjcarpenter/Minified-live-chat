...
var date = JSON.stringify(new Date(Date.now()).toLocaleTimeString())
  ...
  socket.on('updatechat', function (username, data) {
    ...
    $('#conversation').append($('<img id="useravatar" class="ui avatar image" src="/images/avatarsmall.jpg"></img><span class="ui small text" id="username"name="avatar"></span>').text(username));
