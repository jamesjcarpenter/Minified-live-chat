...
//$('#publisher').append('<h4>' + username + '</h4>');
  ...
  // on load of page
socket.on('connect', function(username, data) {
  $('#usercam').empty().append($('<img id="useravatar" class="ui avatar image" src="/images/avatarsmall.jpg"></img><h6></h6>').text(username));
