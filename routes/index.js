...
router.get('/', function(req, res) {
  res.render('home.handlebars', { nonce: res.locals.nonce, name: req.params.name, chat: req.session.chat, username: req.user });
});
...
router.get('/room', function(req, res) {
  ...
  res.locals.query = req.query;
   ...
   res.render('index.ejs', { nonce: res.locals.nonce, name: req.params.name, chat: req.session.chat, username: req.user });
});
...
router.get('/admin', function(req, res) {
  ...
  res.locals.query = req.query;
   res.locals.url   = req.originalUrl;
   res.render('admin.ejs', { nonce: res.locals.nonce, name: req.params.name, chat: req.session.chat, username: req.user });
});

router.get('/dashboard', function(req, res) {
      res.render('dashboard.handlebars', { nonce: res.locals.nonce, name: req.params.name, chat: req.session.chat, username: req.user });
});
