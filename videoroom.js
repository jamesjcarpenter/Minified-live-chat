					...
					//				$('#username').focus();
								...
								onlocalstream: function(stream) {
									...
									if($('#myvideo').length === 0) {
										...
										// Add a 'mute' button
										$('#videolocal').append('<button class="ui mini compact icon button" id="mute" style="position: absolute; bottom: -5px; left: 25px; margin: 15px;"><i class="volume up icon"></i></button>');
										$('#mute').click(toggleMute);
										// Add an 'unpublish' button
										$('#videolocal').append('<button class="ui mini compact icon button" id="unpublish" style="position: absolute; bottom: -5px; right: 25px; margin: 15px;"><i class="times circle icon"></button>');
