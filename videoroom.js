					...
					//				$('#username').focus();
								...
								onlocalstream: function(stream) {
									...
									if($('#myvideo').length === 0) {
										...
										// Add a 'mute' button
										$('#videolocal').append('<button class="ui mini button" id="mute" style="position: absolute; bottom: -30px; left: 0px; margin: 15px;"><i class="volume up icon"></i></button>');
										$('#mute').click(toggleMute);
										// Add an 'unpublish' button
										$('#videolocal').append('<button class="ui mini button" id="unpublish" style="position: absolute; bottom: -30px; right: 0px; margin: 15px;"><i class="times circle icon"></button>');
