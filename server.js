...
app.use(helmet.contentSecurityPolicy({
 directives: {
   defaultSrc: ["'self'", (req, res) => `'nonce-${res.locals.styleNonce}'`, 'https://anomic.io/:', 'https://anomic.io/janus', 'https://anomic.io:8089/janus', 'https://anomic.io:8088/janus', 'https://www.anomic.io:8089/janus', 'https://www.anomic.io:8088/janus', 'https://www.anomic.io:8080/janus', 'https://172.17.0.2:8080/janus'],
   ...
   objectSrc: ["'none'"],
   formAction: ["'self'"],
   connectSrc: ["'self'", 'https://127.0.0.1:8080/janus','https://172.17.0.2:8080/janus', 'wss://www.anomic.io:8089/', 'https://172.17.0.2:8080/janus', 'https://www.anomic.io:8080/janus', 'https://www.youtube.com', 'https://google.com', 'https://youtube.com', 'https://www.google.com', 'https://www.anomic.io:8089/janus', 'https://www.anomic.io/socket.io', 'https://anomic.io/images', 'https://www.anomic.io/images', 'https://anomic.io/socket.io/', 'https://www.anomic.io/socket.io/', 'https://www.anomic.io:8089/socket.io', 'https://anomic.io/socket.io/', 'https://www.anomic.io/socket.io/',  'https://www.anomic.io/images/', 'https://www.anomic.io:8089/*', 'https://www.anomic.io:80', 'https://www.anomic.io:443', 'https://www.anomic.io:8088/janus', 'https://www.anomic.io:*', 'https://www.anomic.io/*', 'https://anomic.io:*', 'wss://anomic.io:*', 'https://anomic.io', 'https://anomic.io:*/janus', 'https://anomic.io/videoroom', 'http://anomic.io/janus', 'http://anomic.io/videoroom', 'https://anomic.io:8089/janus', 'https://anomic.io:8088/janus', 'wss://www.anomic.io:8089/janus', 'ws://www.anomic.io:8089/janus', 'https://www.youtube.com', 'https://www.youtube.com/pagead/viewthroughconversion/', 'https://s.ytimg.com/', 'https://www.vimeo.com/', 'https://api.dmcdn.net/', 'https://dailymotion.com/', 'blob:https://www.youtube.com'],
...
const socketAntiSpam = new SocketAntiSpam({
  ...
  kickThreshold:      66,          // User gets kicked after this many spam score
...
socketAntiSpam.event.on('kick', (socket, data) => {
  console.log(socket +  'was kicked due to spam, please refresh');
  console.log(data)
})
...
io.sockets.on('connection', function (socket) {
  ...
  socket.on('userIdReceived', (userId) => {
    ...
    var userNameOfUserToFind;
     User.findOne({ userNameOfUserToFind : socket }).exec(function(err,res) {
       console.log(res);
    ...
    //update users for current room
      ...
      function requestUse() {
        io.emit('updateuserhome', clients);
        };
        setInterval(requestUse, 2500);
