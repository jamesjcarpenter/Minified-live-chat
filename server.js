...
app.use(helmet.contentSecurityPolicy({
 directives: {
   ...
   styleSrc: ["'self'", (req, res) => `'nonce-${res.locals.styleNonce}'`, "'unsafe-inline'", 'https://www.anomic.io/js/*', 'https://anomic.io/js/*', 'https://anomic.io/js', 'https://anomic.io/scripts', 'https://cdnjs.cloudflare.com/', 'https://maxcdn.bootstrapcdn.com/', 'https://toert.github.io/', 'https://fonts.googleapis.com/', 'https://anomic.io/semantic', 'https://anomic.io/semantic/dist/', 'https://unpkg.com', ],
