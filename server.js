...
app.use(helmet.contentSecurityPolicy({
 directives: {
   ...
   imgSrc: ["'self'", 'https://csi.gstatic.com', 'https://img.youtube.com/'],
   objectSrc: ["'none'"],
   formAction: ["'self'"],
   ...
   frameSrc: ["'self'", 'https://www.webrtc-experiment.com/', 'https://img.youtube.com/', 'https://www.youtube.com/', 'https://content.googleapis.com/', 'https://www.content.googleapis.com/', 'https://www.googleads.g.doubleclick.net/', 'https://www.static.doubleclick.net'],
...
io.sockets.on('connection', function (socket) {
  ...
  socket.on('userIdReceived', (userId) => {
    ...
    socket.to(socket.room).broadcast.emit('updateusers', usernames, socket.id);
    // console.log(usernames);
    socket.to(socket.room).broadcast.emit('updaterooms', rooms, socket.room);
