...
app.use(helmet.contentSecurityPolicy({
 directives: {
   ...
   objectSrc: ["'none'"],
   formAction: ["'self'"],
   connectSrc: ['https://anomic.io:*', 'wss://anomic.io', 'ws://anomic.io', 'https://anomic.io', 'https://anomic.io/janus', 'https://anomic.io/videoroom', 'http://anomic.io/janus', 'http://anomic.io/videoroom', 'https://anomic.io:8089/janus', 'https://anomic.io:8088/janus' ],
