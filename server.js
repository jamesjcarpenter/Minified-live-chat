...
app.use(helmet.contentSecurityPolicy({
 directives: {
   defaultSrc: ['https://anomic.io/:', 'nonce-4AEemGb0xJptoIGFP3Nd'],
   ...
   fontSrc: ["'self'", "'unsafe-inline'", 'https://fonts.gstatic.com', 'https://maxcdn.bootstrapcdn.com/', 'https://fonts.googleapis.com/'],
   imgSrc: ["'self'"],
   objectSrc: ["'none'"],
   formAction: ["'self'"],
