...
app.use(helmet.contentSecurityPolicy({
 directives: {
   ...
   scriptSrc: ["'self'", (req, res) => `'nonce-${res.locals.styleNonce}'`, 'https://anomic.io/socket.io/', 'https://apis.google.com/', 'https://www.anomic.io/socket.io/', '/socket.io/socket.io.js', 'https://anomic.io/socket.io/', 'https://www.anomic.io/socket.io/',  'https://anomic.io/semantic', 'https://anomic.io/handlebars', 'https://anomic.io/janus', 'https://www.anomic.io/janus', 'https://www.anomic.io/janus/*', 'https://www.anomic.io/videoroom', 'https://anomic.io/videoroom', 'https://www.anomic.io/semantic', 'https://www.anomic.io/semantic/*', 'https://www.anomic.io/jquery/*', 'https://anomic.io/jquery/*', 'https://anomic.io/videoroom', 'https://anomic.io/simplewebrtc', 'https://anomic.io/socket.io', 'https://anomic.io/js', 'https://anomic.io/jquery/dist/jquery.js', 'https://code.jquery.com/', 'https://maxcdn.bootstrapcdn.com/', 'https://cdnjs.cloudflare.com/', 'https://toert.github.io', 'https://www.webrtc-experiment.com/', 'https://unpkg.com/', 'https://apis.google.com/js/googleapis.proxy.js?onload=startup', 'https://apis.google.com/js/client.js?onload=handleClientLoad'],
